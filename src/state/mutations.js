...
export const setPolicyInstances = createMutation(
  'policyInstances',
  (state, {organizationId, policyId, policyInstances}) => {
    state.policyInstancesById = {
      ...state.policyInstancesById,
      [organizationId]: {...state.policyInstancesById[organizationId], [policyId]: policyInstances}
    }
  }
)
